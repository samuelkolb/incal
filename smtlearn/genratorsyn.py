...
from incalforrandom import Learner
...
class Generator(object):
    ...
    def generate_data_set(self):
        for i in range(self.max_tries):
            try:
                return self.generate_lp().get_data(self.sample_count, self.max_ratio)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--/Users/Elias/Desktop/N")
    ...
    data_dir="/Users/Elias/Desktop/N:n"
    print(data_dir)
